...
class Table {
 ...
 private:
    ...
    * 
    * hashTable is an array of type ListType pointers 
    * hashTable's size is either HASH_SIZE or hSize (hSize > 0)
    * 
    * numOfEntries >= 0
    * 
    */
   ...
   /**
    * nonEmptyBuckets returns the number of non-empty buckets
    * in the table
    * 
    * @return int 
    */
   ...
   /**
    * longestChain returns the longest number of nodes a bucket has
    * 
    * @return int 
    */
